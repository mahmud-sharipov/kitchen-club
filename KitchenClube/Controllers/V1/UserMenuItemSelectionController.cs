...
[Route("api/{v:apiVersion}/usermenuitemselections/")]
[ApiController]
[ApiVersion("1.0")]
[Authorize]
public class UserMenuItemSelectionController : ControllerBase
{
    private readonly Services.V1.IUserMenuItemSelectionService _userMenuItemSelection;
    public UserMenuItemSelectionController(Services.V1.IUserMenuItemSelectionService userMenuItemSelection)
    {
