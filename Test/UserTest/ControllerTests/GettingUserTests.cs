...
public class GettingUserTests : BaseTest
{
    ...
    [Fact]
    public async void GetById_ExistingGuidPassed_ReturnsUserResponse()
    {
    ...
    [Fact]
    public async void GetRoles_UnknownGuidPassed_ReturnsNotfoundResponse()
    {
    ...
    [Fact]
    public async void GetRoles_ValidObjectPassed_ReturnsRolesOfUser()
    {
