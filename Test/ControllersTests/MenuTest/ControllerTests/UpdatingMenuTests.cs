...
{
    [Fact]
    public async Task Update_InValidGuidPassed_ReturnsNotFoundException()
    {
        var id = Guid.NewGuid();
    ...
    [Fact]
    public async Task UpdateStatusOpen_InValidGuidPassed_ReturnsNotFoundException()
    {
        var id = Guid.NewGuid();
    ...
    [Fact]
    public async Task UpdateStatusOpen_ValidGuidPassed_VerifiesStatusUpdate()
    {
    ...
    [Fact]
    public async Task UpdateStatusClose_InValidGuidPassed_ReturnsNotFoundException()
    {
        var id = Guid.NewGuid();
    ...
    [Fact]
    public async Task UpdateStatusClose_ValidGuidPassed_VerifiesStatusUpdate()
    {
        var id = new Guid("F823140D-70B0-40A0-BF54-03874C6BA0C9");
