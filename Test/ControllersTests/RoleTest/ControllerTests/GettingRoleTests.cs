...
{
    [Fact]
    public async Task Get_WhenCalled_ReturnsAListOfRoleResponse()
    {
    ...
    [Fact]
    public async Task GetById_UnknownRoleIdPassed_ReturnsNotFoundResponse()
    {
    ...
    [Fact]
    public async Task GetById_ExistingRoleIdPassed_ReturnsRoleResponse()
    {
