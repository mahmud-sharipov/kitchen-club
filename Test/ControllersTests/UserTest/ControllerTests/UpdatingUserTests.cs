...
{
    [Fact]
    public async Task Update_InvalidUserIdPassed_ReturnsNotFoundReponse()
    {
    ...
    [Fact]
    public async Task Update_ValidObjectsPassed_VerifiesUpdate()
    {
    ...
    [Fact]
    public async Task UpdateRole_UnknownGuidPassed_ReturnsNotFoundResponse()
    {
        var userIdTest = Guid.NewGuid();
    ...
    [Fact]
    public async Task UpdateRole_ValidObjectsPassed_ReturnsTaskCompleted()
    {
        var userIdTest = new Guid("2EA3E5EB-CBCB-4A67-B868-61B96F9A9D60");
        var roles = new List<string>() { "User" };
        var updateRolesTest = new UpdateUserRole(roles);
